...
class ProteinSearchServiceTestCase(unittest.TestCase):
    ...
    def __basic_test_search(self,pdb_id, expected_protein_result, test_scondary_structure=False, test_missing_residues=False):
        ...
        for i in range(len(expected_protein_result["chains"])):
            ...
            self.assertEqual(len(actual_response_chain["residues"]),len(actual_expected_protein_result_chain["residues"]))
    ...
    def __basic_test_missing_residues(self, missing_testing_residues_list, missing_expected_residues_list, derive_missing_residues_list):
        ...
        for n in range(len(missing_testing_residues_list)):
            ...
            for i in range(len(actual_missing_expected_residue)):
                ...
                self.assertEqual(actual_response_basic_p0a6b9_residue["content_count"],actual_expected_basic_p0a6b9_residue["content_count"])
                self.assertEqual(actual_response_basic_p0a6b9_residue["content_fraction"],actual_expected_basic_p0a6b9_residue["content_fraction"])
                self.assertEqual(len(actual_response_basic_p0a6b9_residue["regions"]),len(actual_expected_basic_p0a6b9_residue["regions"]))
                try:
                    self.assertEqual(actual_response_basic_p0a6b9_residue["source_id"],actual_expected_basic_p0a6b9_residue["source_id"])
                except:
                    pass
    ...
    def test_search_3lvl(self):
        resposne = self.__basic_test_search("3lvl",_3lvl)
        self.assertEqual(len(resposne["missing_residues"]),len(_3lvl["missing_residues"]))
        response_p0a6b9 = resposne["missing_residues"][0]["P0A6B9"]
        response_p0acd6 = resposne["missing_residues"][1]["P0ACD6"]
        ...
        derive_missing_residues_p0a6b9 = ["derived-missing_residues-mobi-3lvj_A","derived-missing_residues-mobi-3lvj_B",
        "derived-missing_residues-mobi-3lvk_A","derived-missing_residues-mobi-3lvl_B","derived-missing_residues-mobi-3lvm_A",
        "derived-missing_residues-mobi-3lvm_B","derived-missing_residues-priority","derived-missing_residues-th_90","derived-missing_residues_context_dependent-th_90"]
        derive_missing_residues_p0acd6 = ["derived-missing_residues-mobi-3lvl_A","derived-missing_residues-priority","derived-missing_residues-th_90"]
        self.__basic_test_missing_residues([response_p0a6b9,response_p0acd6],[expected_p0a6b9,expected_p0acd6],[derive_missing_residues_p0a6b9,derive_missing_residues_p0acd6])
